...
},{"./failpage.js":40,"./navbar.js":43}],40:[function(require,module,exports){
"use strict";
...
},{"./app.js":38}],43:[function(require,module,exports){
'use strict';
...
},{"./agenda.js":37,"./home.js":41,"./logout.js":42,"./scheduleMaker.js":47,"./skipaday.js":48,"./template.js":49,"./types.js":50,"./users.js":51}],44:[function(require,module,exports){
'use strict';
...
var Popup = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { className: 'confirm-bg', onClick: this.handleClick },
            React.createElement(
                'div',
                { className: 'confirm col-md-2 col-md-offset-5', onClick: this.handleClick },
                React.createElement(
                    'div',
...
var ScheduleMaker = React.createClass({
    ...
    sendSchedule: function sendSchedule(action) {
        var element = this;
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'col-xs-6 col-sm-6' },
                    React.createElement('input', { className: 'btn', type: 'button', value: 'Send!', onClick: element.popup })
                )
            ),
            React.createElement(
                'div',
            ...
            element.state.showConfirm ? React.createElement(Popup, { message: 'Send this schedule?', handleClick: element.sendSchedule }) : null
        );
    }
});
...
},{"./popup.js":44}],48:[function(require,module,exports){
'use strict';
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'div',
                                { className: 'col-xs-8' },
                                React.createElement('input', { className: 'form-control typeInput', type: 'text', 'data-id': type.id, defaultValue: type.name, onChange: element.changeName })
                            ),
                            React.createElement(
                                'div',
                                { className: 'col-xs-3' },
                            ...
                            React.createElement(
                                'div',
                                { className: 'col-xs-1' },
                                React.createElement('i', { className: 'fa fa-times pull-right delete', 'data-id': type.id, 'aria-hidden': 'true', onClick: element.removeType })
                            )
                        )
                    )
                );
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'form',
                        { className: 'form-inline' },
                        React.createElement('input', { className: 'form-control', placeholder: 'Name', type: 'text', ref: 'name' }),
                        React.createElement(
                            'select',
            ...
            if (user) {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('i', { className: 'fa fa-times pull-right delete', 'data-table': 'users', 'data-id': user.id, 'aria-hidden': 'true', onClick: element.popup })
                    )
                );
            }
        });
